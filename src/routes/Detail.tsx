...
export const Detail = () => {
  ...
  const onClickFav = () => {
    axios.patch(`https://127.0.0.1:8000/user/${paramss.user}/fav?favourite_item=${pizza.id}`).then(res => {
          ...
          <div className='pizza-block-wrapper px-5 py-5'>
            <div className='pizza-detail-block bg-white h-auto rounded-xl pb-3'>
              ...
              <div className='pizza-detail-info'>
                <h4 className='font-term uppercase text-xl pl-3 pt-2'>{pizza.name}</h4>
